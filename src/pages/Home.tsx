        ...
        <div className={`wrap ${styles.heroInner}`}>
          ...
          <div className={styles.heroRight}>
            <div className={styles.heroImgWrap}>
              <img className={styles.heroImgMain} src="/assets/products/1.jpg" alt="Classic Protein Bhel" />
      ...
      <section className={styles.why}>
        <div className={`wrap ${styles.whyGrid}`}>
          <div className={styles.whyImages}>
            <div className={`${styles.whyImg} ${styles.tall}`}><img src="/assets/products/8.jpg" alt="Premium Dry Fruit Bhel" /></div>
            <div className={styles.whyImg}><img src="/assets/products/4.jpg" alt="Chatpata Fiber Bhel" /></div>
            <div className={styles.whyImg}><img src="/assets/products/5.jpg" alt="Jaggery Bhel" /></div>
          </div>
